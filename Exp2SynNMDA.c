...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 pnt_receive_size[_mechtype] = 1;
 	...
 	ivoc_help("help ?1 Exp2SynNMDA Exp2SynNMDA.mod\n");
...
double vspom ( _threadargsprotocomma_ double _lv ) {
   double _lvspom;
 _lvspom = 1.50265 / ( 1. + 0.33 * extMgConc * exp ( alpha_vspom * ( _lv - v0_block ) ) ) ;
